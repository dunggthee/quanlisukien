...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>TNTECH | Thêm Nội Dung</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Thêm Nội Dung </h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Chi Tiết Nội Dung</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Ảnh Nội Dung</b></h4>
