...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>TNTECH | Thêm Sư Kiện Phụ</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Thêm Sự Kiện </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
                                                    <label class="col-md-2 control-label">Sự Kiện</label>
                                                    <div class="col-md-10">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Chi Tiết Sự Kiện</label>
	                                                <div class="col-md-10">
