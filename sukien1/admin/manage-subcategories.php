...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title> Sự Kiện | Quản Lí Sự Kiện</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản Lí Sự Kiện</h4>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Sự Kiện Đã Xoá</h4>
...
<td colspan="7" align="center"><h3 style="color:red">Không có sự kiện </h3></td>
<tr>
<?php 
} else {
