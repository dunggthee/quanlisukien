...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>TNTECH | Quản Lí Nội Dung</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Nội Dung Hoàn Thành </h4>
...
<td colspan="4" align="center"><h3 style="color:red">Không tìm thấy nội dung</h3></td>
<tr>
<?php 
} else {
