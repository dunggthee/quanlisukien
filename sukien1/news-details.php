...
?>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <p><b>Thể Loại: </b> <a href="category.php?catid=<?php echo htmlentities($row['cid'])?>"><?php echo htmlentities($row['category']);?></a> |
                <b>Sự Kiện: </b><?php echo htmlentities($row['subcategory']);?> <b> Đăng Ngày </b><?php echo htmlentities($row['postingdate']);?></p>
                <hr />
